...
//             imagePrompt: page.imagePrompt ? this.personalizeText(page.imagePrompt, book.childName, book.childAge) : undefined,
//         }));
...
//         return text.replace(/{nome}/g, childName).replace(/{idade}/g, childAge);
//     }
